...
# get current version
eval $(grep "^PE_VERSION_" vendor/pe/config/pe_common.mk | sed 's/ *//g')
VERSION="$PE_VERSION_MAJOR.$PE_VERSION_MINOR.$PE_VERSION_MAINTENANCE"
...
echo -e ""
echo -e ${bldblu}"Looking dependencies${txtrst}"${cya}
...
rm -f out/target/product/$device/pe_*-ota*.zip
